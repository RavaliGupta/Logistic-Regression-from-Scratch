...
def compute_error_for_graph_given_points(thetha1,thetha2,thetha3,thetha4,x1,x2,x3,x4,y):
    totalError = 0
    max_x1=np.amax(x1)
    min_x1=np.amin(x1)
    mean_x1=np.mean(x1)
    ...
    for i in range(1, len(x1)):
      ...
      feature_x4= (x4[i]-mean_x4)/(max_x4-min_x4)
      h_thetha= 1/(1+np.e**(-((feature_x1*thetha1)+(feature_x2*thetha2)+(feature_x3*thetha3)+(feature_x4*thetha4))))
...
def step_gradient(thetha_current1,thetha_current2, thetha_current3,thetha_current4, x1,x2,x3,x4,y, learningRate,l_lambda):
    thetha_gradient1 = 0
    thetha_gradient2 = 0
    thetha_gradient3 = 0
    thetha_gradient4 = 0
    ...
    for i in range(1, len(x1)):   
        ...
        feature_x3= (x3[i]-mean_x3)/(max_x3-min_x3)
        feature_x4= (x4[i]-mean_x4)/(max_x4-min_x4)
        h_thetha= 1/(1+np.e**(-((feature_x1*thetha_current1)+(feature_x2*thetha_current2)+(feature_x3*thetha_current3)+(feature_x4*thetha_current4))))
       # print("hypothesis is::::",h_thetha)
        #np.exp(thetha_current*feature_x)/(1+np.exp(thetha_current*feature_x))
        exp_factor=np.e**(-((thetha_current1*feature_x1)+(thetha_current2*feature_x2)+(thetha_current3*feature_x3)+(thetha_current4*feature_x4)))
        ...
        x4_factor=((x4[i]*exp_factor)/((1+exp_factor)*(1+exp_factor)))
        ...
        thetha_gradient4 +=  (((y[i])*(math.log(h_thetha)))+((1-y[i])*(math.log(1-h_thetha))))*x4_factor
    ...
    new_thetha3 = thetha_current3*(1-(learningRate*l_lambda/N)) - ((learningRate/N) * thetha_gradient3)
    new_thetha4 = thetha_current4*(1-(learningRate*l_lambda/N)) - ((learningRate/N) * thetha_gradient4)
   
    #print("thetha after gradient descent",new_thetha1)
    return  [new_thetha1,new_thetha2,new_thetha3,new_thetha4]
    
def gradient_descent_runner(x1,x2,x3,x4,y, starting_thetha1,starting_thetha2, starting_thetha3,starting_thetha4,learning_rate, num_iterations,l_lambda):
    thetha1 = starting_thetha1
    thetha2 = starting_thetha2
    thetha3 = starting_thetha3
    thetha4 = starting_thetha4
    for i in range(num_iterations):
        [new_thetha1,new_thetha2,new_thetha3,new_thetha4] = step_gradient(thetha1,thetha2,thetha3,thetha4, x1,x2,x3,x4,y, learning_rate,l_lambda)    
    #print("",)
    return [new_thetha1,new_thetha2,new_thetha3,new_thetha4]
    
    
def sigmoid(thetha1,thetha2,thetha3,thetha4,x1,x2,x3,x4):
    a = []
    max_x1=np.amax(x1)
    min_x1=np.amin(x1)
    mean_x1=np.mean(x1)
    ...
    #y=np.exp(b*feature_x)/(1+np.exp(b*feature_x))
        a.append(1/(1+np.e**(-((feature_x1*thetha1)+(feature_x2*thetha2)+(feature_x3*thetha3)+(feature_x4*thetha4)))))
...
def run():
    ...
    x4 = np.array(points_training['FractalDimension'])
    ...
    x4_test = np.array(points_test['FractalDimension'])
    ...
    threshold= 0.5
   # plt.show()
    print ("Starting gradient descent at  thetha1 = {0}, thetha2 = {1}, thetha3 = {2}, thetha4= {3},  error = {4}".format(initial_thetha1, initial_thetha2, initial_thetha3, initial_thetha4, compute_error_for_graph_given_points(initial_thetha1,initial_thetha2, initial_thetha3,initial_thetha4, x1,x2,x3,x4,y)))
    print ("Running...")  
    [thetha1,thetha2,thetha3,thetha4] = gradient_descent_runner(x1,x2,x3,x4,y, initial_thetha1,initial_thetha2,initial_thetha3, initial_thetha4, learning_rate, num_iterations,l_lambda)    
   ...
   # print("value of feature x after appending array is:::",x_array)
    ...
    y_sigmoid=sigmoid(thetha1,thetha2,thetha3,thetha4,x1_test,x2_test,x3_test,x4_test)
    ...
    plt.xlabel('Texture,Area,Concavity,FractalDimension')
    plt.plot(x_features,y_predict, color='r')
    plt.show()
    print("After {0} iterations thetha1 = {1}, thetha2={2}, thetha3={3},thetha4= {4},error = {5}".format(num_iterations, thetha1,thetha2,thetha3,thetha4, compute_error_for_graph_given_points(thetha1,thetha2,thetha3,thetha4, x1,x2,x3,x4,y)))
