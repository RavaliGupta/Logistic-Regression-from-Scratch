...
def step_gradient(thetha_current1,thetha_current2, thetha_current3,thetha_current4, x1,x2,x3,x4,y, learningRate):
    thetha_gradient1 = 0
    thetha_gradient2 = 0
    thetha_gradient3 = 0
    thetha_gradient4 = 0
    ...
    new_thetha4 = thetha_current4 - ((learningRate/N) * thetha_gradient4)
   
    #print("thetha after gradient descent",new_thetha1)
    return  [new_thetha1,new_thetha2,new_thetha3,new_thetha4]
    
def gradient_descent_runner(x1,x2,x3,x4,y, starting_thetha1,starting_thetha2, starting_thetha3,starting_thetha4,learning_rate, num_iterations):
    thetha1 = starting_thetha1
    thetha2 = starting_thetha2
    thetha3 = starting_thetha3
    thetha4 = starting_thetha4
    for i in range(num_iterations):
        [new_thetha1,new_thetha2,new_thetha3,new_thetha4] = step_gradient(thetha1,thetha2,thetha3,thetha4, x1,x2,x3,x4,y, learning_rate)    
    #print("",)
    return [new_thetha1,new_thetha2,new_thetha3,new_thetha4]
...
def run():
   ...
   # plt.show()
    ...
    print ("Running...")  
    [thetha1,thetha2,thetha3,thetha4] = gradient_descent_runner(x1,x2,x3,x4,y, initial_thetha1,initial_thetha2,initial_thetha3, initial_thetha4, learning_rate, num_iterations)    
